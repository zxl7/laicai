...
export function Sectors() {
  ...
  useEffect(() => {
    if (strongStocks.length > 0) {
      ...
      // 模拟板块数据 - 在实际应用中，应该从新接口获取真实板块数据
      // 这里我们根据股票名称或代码简单模拟一些板块
      const mockSectors: Sector[] = [
        {
          id: 'sector_1',
          name: '科技板块',
          code: 'TECH',
          limit_up_stocks: Math.floor(Math.random() * 5) + 1,
          rising_stocks: Math.floor(Math.random() * 20) + 5,
          falling_stocks: Math.floor(Math.random() * 10),
          limit_down_stocks: Math.floor(Math.random() * 3),
          trend_direction: Math.random() > 0.5 ? 'up' : Math.random() > 0.5 ? 'down' : 'sideways',
          is_rising: Math.random() > 0.3,
          is_falling: Math.random() < 0.2,
        ...
        },
        {
          ...
          name: '金融板块',
          code: 'FINANCE',
          limit_up_stocks: Math.floor(Math.random() * 4) + 1,
          rising_stocks: Math.floor(Math.random() * 15) + 5,
          falling_stocks: Math.floor(Math.random() * 8),
          limit_down_stocks: Math.floor(Math.random() * 2),
          trend_direction: Math.random() > 0.5 ? 'up' : Math.random() > 0.5 ? 'down' : 'sideways',
          is_rising: Math.random() > 0.4,
          is_falling: Math.random() < 0.25,
          updated_at: new Date().toISOString()
        },
        {
          id: 'sector_3',
          name: '医药板块',
          code: 'MEDICAL',
          limit_up_stocks: Math.floor(Math.random() * 6) + 1,
          rising_stocks: Math.floor(Math.random() * 25) + 10,
          falling_stocks: Math.floor(Math.random() * 12),
          limit_down_stocks: Math.floor(Math.random() * 4),
          trend_direction: Math.random() > 0.5 ? 'up' : Math.random() > 0.5 ? 'down' : 'sideways',
          is_rising: Math.random() > 0.35,
          is_falling: Math.random() < 0.22,
          updated_at: new Date().toISOString()
        },
        {
          id: 'sector_4',
          name: '新能源板块',
          code: 'NEW_ENERGY',
          limit_up_stocks: Math.floor(Math.random() * 7) + 2,
          rising_stocks: Math.floor(Math.random() * 30) + 15,
          falling_stocks: Math.floor(Math.random() * 10),
          limit_down_stocks: Math.floor(Math.random() * 3),
          trend_direction: Math.random() > 0.5 ? 'up' : Math.random() > 0.5 ? 'down' : 'sideways',
          is_rising: Math.random() > 0.3,
          is_falling: Math.random() < 0.18,
          updated_at: new Date().toISOString()
        },
        {
          id: 'sector_5',
          ...
          code: 'CONSUMER',
          limit_up_stocks: Math.floor(Math.random() * 5) + 1,
          rising_stocks: Math.floor(Math.random() * 20) + 8,
          falling_stocks: Math.floor(Math.random() * 15),
          limit_down_stocks: Math.floor(Math.random() * 4),
          trend_direction: Math.random() > 0.5 ? 'up' : Math.random() > 0.5 ? 'down' : 'sideways',
          is_rising: Math.random() > 0.4,
          is_falling: Math.random() < 0.25,
